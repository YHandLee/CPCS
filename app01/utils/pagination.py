...
class Pagination(object):
    ...
    def __init__(self, request, queryset, page_size=10, page_param="page", plus=5):
        """
        :param request: 请求的对象
        :param queryset: 查询符合条件的数据（根据这个数据给他进行分页处理）
    ...
    def html(self):
        ...
        # 尾页
        self.query_dict.setlist(self.page_param, [self.total_page_count])
        final_page = '<li><a href="?{}">尾页</a></li>'.format(self.query_dict.urlencode())
        page_str_list.append(final_page)
